...
describe('neo-slack.nvim', function()
  ...
  before_each(function()
    ...
    state_mock = mock({
      get_current_channel = function() return 'channel_id', 'channel_name' end,
      set_current_channel = function() end,
      set_messages = function() end,
      set_current_thread = function() end,
      set_thread_messages = function() end,
      get_current_thread = function() return nil end
    }, true)

    storage_mock = mock({
      save_token = function() return true end,
      delete_token = function() return true end
    }, true)
    ...
    initialization_mock = mock({
      start = function(callback) if callback then callback(true) end end,
      get_status = function() return { is_initialized = true, is_initializing = false, current_step = 8, total_steps = 8 } end
    }, true)
  ...
  describe('list_messages', function()
    it('should use default channel when none provided', function()
      ...
      state_mock.get_current_channel = function() return nil, nil end
    ...
    it('should use current channel when available', function()
      -- state_mockの挙動を設定
      state_mock.get_current_channel = function() return 'current-channel', 'Current Channel' end
